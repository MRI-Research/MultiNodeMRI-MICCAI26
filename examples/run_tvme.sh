...
RAW_DATA_DIR="${1:?Usage: run_tvme.sh RAW_DATA_DIR PREPARED_DIR OUTPUT_DIR}"
PREPARED_DIR="${2:?Usage: run_tvme.sh RAW_DATA_DIR PREPARED_DIR OUTPUT_DIR}"
OUTPUT_DIR="${3:?Usage: run_tvme.sh RAW_DATA_DIR PREPARED_DIR OUTPUT_DIR}"
